    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="section-title">
                ...
                <h1 class="display-4">Sabores de Nieves</h1>

                <!-- NIEVE DE LECHE -->
                <h2 class="">Nieve de Leche</h2>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor cajeta</p>
                    ...
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor rompope</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor chocolate</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor fresa colada</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor piña colada</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor mango colado</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor mazapán</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor Oreo</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor Nutella</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor 3 leches</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor vainilla</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor café</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor cereza</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor queso</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                </div>
