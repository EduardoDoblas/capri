    ...
    <div class="row">
        <?php foreach ($nieves as $res) { ?>
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img class="card-img-top rounded-circle" src="img/menu-1.png" alt="">
                    <div class="card-body">
                        
                        <h4 class="card-title"><?php echo $res['nombre']; ?></h4>
                        <p class="card-text"><?php echo $res['estatus']; ?></p>
                        <p class="card-text"><?php echo $res['descripcion']; ?></p>

                        <form id="pedidoForm" method="post" action="formulario_agregar_pedido.php">
                            <input type="hidden" name="nombre" value="<?php echo $res['nombre']; ?>">
                            <input type="hidden" name="estatus" value="<?php echo $res['estatus']; ?>">
...
<!-- Agregar script JavaScript al final del cuerpo HTML -->
<script>
    function agregarProducto(id, nombre, estatus, descripcion) {
        ...
        $.ajax({
            ...
            success: function(response) {
                // Manejar la respuesta, por ejemplo, actualizar el contenido de una div
