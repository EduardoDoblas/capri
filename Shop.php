...
<body>
   ...
   <div class="container-fluid p-0 nav-bar">
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4">
                    ...
                    <a href="css_login/cerrar_sesion_be.php" class="nav-item nav-link"> CERRAR SESION</a>
                    <a href="usuario.php" class="nav-item nav-link"><i class="bi bi-person-circle" style="font-size: 30px;"></i></a>
                    <a href="Shop.php" class="nav-item nav-link"> <i class="bi bi-cart-fill align-middle" style="font-size: 30px;"></i>(0)</a> <!-- Establecido un tamaño de 24px -->
                </div>
            </div>
        </nav>
    </div> <!-- Navbar End -->
    ...
    <body>
    <?php
                    $comentariosQry = "SELECT * FROM pedido";
                        ...
                        <form method="post" action='eliminar_nieves.php'>
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <input type="hidden" name="nombre" value="<?php echo $res['id_nieve']; ?>">
                                            <td><a><?php echo $res['nombre']; ?></a></td>
                                            <td><a><?php echo $res['estatus']; ?></a></td>
                                            <td><a><?php echo $res['descripcion']; ?></a></td>
                                            <td>
                                                <form method="POST" action="eliminar_pedido.php" onsubmit="return confirm('¿Estás seguro de que deseas eliminar esta fila?');"> 
                            ...
                            <a href="reportes_pedido.php" target="_blank" class="btn btn-success">Generar Reportes</a>
                        </form>
