                ...
                <div class="col-lg-6">
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor pay de mango</p>
                    ...
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor pay de fresa</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor pay de guayaba</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor pay de piña</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor pay de limón</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            <h4>
                                <a>Pay de Zarzamora</a>
                            </h4>
                            <p class="m-0">Nieve de raspa de sabor pay de zarzamora</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor pay de durazno</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                    <div class="row align-items-center mb-5">
                        ...
                        <div class="col-8 col-sm-9">
                            ...
                            <p class="m-0">Nieve de raspa de sabor pay de cereza</p>
                            <button class="btn btn-primary add-to-cart" data-name="Cajeta" data-price="5.00">Agregar Producto</button>
                        </div>
                    </div>
                </div>
