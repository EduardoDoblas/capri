        ...
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4">
                    ...
                    <a href="usuario.php"><i class="bi bi-cart-fill align-middle" style="font-size: 30px;"></i></a> <!-- Establecido un tamaño de 24px -->
                </div>
            </div>
        </nav>
    </div>
            ...
            <div id="info">
                <div class="row">
                    ...
                    <div class="Capri">
                                ...
                                <a class="btn btn-success" href="about.php">Leer más</a>
                            </div>
                            <br>
                            <br>
                            <br>
...
<div class="container-fluid p-0 mb-5">
        <div id="blog-carousel" class="carousel slide overlay-bottom" data-ride="carousel">
            <div class="carousel-inner">
                <!-- Carousel 1 -->
                <div class="carousel-item active">
                    <img class="w-100" src="img/promocion1.jpg" alt="Image" height="500px"  width="100px">
                    
                </div>
                <!-- Carousel 2 -->
                <div class="carousel-item">
                    <img class="w-100" src="img/promocion2.jpg" alt="Image" height="500px"  width="700PX">
    ...
    <div class="section-title">
    <h1 class="display-4">Sabores más comprados</h1>
</div>
...
<div class="container">
    <div class="row">
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img class="card-img-top rounded-circle" src="img/Limon.png" alt="">
                    <div class="card-body">
                        
                        <h4 class="card-title">Limón</h4>
                        <p class="card-text">$55</p>
                        <p class="card-text">Nieve de limón</p>
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img class="card-img-top rounded-circle" src="img/Fresa.png" alt="">
                    <div class="card-body">
                        
                        <h4 class="card-title">Fresa</h4>
                        <p class="card-text">$65</p>
                        <p class="card-text">Nieve de Fresa</p>
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img class="card-img-top rounded-circle" src="img/Oreo.png" alt="">
                    <div class="card-body">
                        
                        <h4 class="card-title">Oreo</h4>
                        <p class="card-text">$75</p>
                        <p class="card-text">Nieve de Oreo</p>
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img class="card-img-top rounded-circle" src="img/Chocolate.png" alt="">
                    <div class="card-body">
                        
                        <h4 class="card-title">Chocolate</h4>
                        <p class="card-text">$65</p>
                        <p class="card-text">Nieve de Chocolate</p>
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img class="card-img-top rounded-circle" src="img/cereza.png" alt="">
                    <div class="card-body">
                        
                        <h4 class="card-title">Cereza</h4>
                        <p class="card-text">$75</p>
                        <p class="card-text">Nieve de Cereza</p>
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img class="card-img-top rounded-circle" src="img/pay de zarzamora.png" alt="">
                    <div class="card-body">
                        
                        <h4 class="card-title">Pay de Zarzamora</h4>
                        <p class="card-text">$85</p>
                        <p class="card-text">Nieve de Zarzamora</p>
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img class="card-img-top rounded-circle" src="img/cerveza.png" alt="">
                    <div class="card-body">
                        
                        <h4 class="card-title">Root Beer</h4>
                        <p class="card-text">$65</p>
                        <p class="card-text">Nieve de Root Beer</p>
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img class="card-img-top rounded-circle" src="img/Mango.png" alt="">
                    <div class="card-body">
                        
                        <h4 class="card-title">Mango</h4>
                        <p class="card-text">$55</p>
                        <p class="card-text">Nieve de Mango</p>
